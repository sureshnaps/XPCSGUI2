function [imgs,headers] = collectimg(immfilename,first_image,last_image)
% --- COLLECTIMG Accumulate a bunch of images into a 3-D image array
% ---
% --- USAGE : [imgs,headers] = COLLECTIMG(FILENAME,FIRST_IMAGE_NUM,LAST_IMAGE_NUM)
% ---
% --- Input Argument:
